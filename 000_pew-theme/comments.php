...
<div id="respond">
  ...
  <h2><?php comment_form_title( '¿Nos dejas tu comentario?', 'Deja tu comentario para %s' ); ?></h2>
  ...
  <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
    ...
    <div>
      <input name="submit" type="submit" id="submit" class="btn btn-sand right" tabindex="5" value="<?php _e('enviar comentario', 'theme ysf'); ?>" />
